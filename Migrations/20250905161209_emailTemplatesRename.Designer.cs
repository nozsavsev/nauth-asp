...
namespace nauth_asp.Migrations
{
    ...
    [Migration("20250905161209_emailTemplatesRename")]
    partial class emailTemplatesRename
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("nauth_asp.Models.EmailTemplate.DB_EmailTemplate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("nauth_asp.Models.User.DB_User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("nauth_asp.Models.EmailAction.DB_EmailAction", b =>
                {
                    b.HasOne("nauth_asp.Models.User.DB_User", null)
            ...
            modelBuilder.Entity("nauth_asp.Models.Permissions.DB_UserPermission", b =>
                {
                    ...
                    b.HasOne("nauth_asp.Models.User.DB_User", "user")
                        .WithMany("permissions")
